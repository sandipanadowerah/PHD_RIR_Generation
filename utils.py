...
with open('config_rir.json', 'r') as f:
...
ctrain_files_file = open('./filelists/c_parking.txt', 'r')
list_parking = ctrain_files_file.readlines()
np.random.seed(12345)
np.random.shuffle(list_parking)

ctrain_files_file = open('./filelists/c_rain.txt', 'r')
list_rain = ctrain_files_file.readlines()
np.random.seed(12345)
np.random.shuffle(list_rain)

ctrain_files_file = open('./filelists/c_wind.txt', 'r')
list_wind = ctrain_files_file.readlines()
np.random.seed(12345)
np.random.shuffle(list_wind)
...
def get_noise_segment_(noise_type, case, duration):
    ...
    if noise_type == 'parking':
        n, fs, n_file, n_file_start = read_random_part(list_parking, duration)
    elif noise_type == 'rain':
        n, fs, n_file, n_file_start = read_random_part(list_rain, duration)
    elif noise_type == 'wind':
        n, fs, n_file, n_file_start = read_random_part(list_wind, duration)
